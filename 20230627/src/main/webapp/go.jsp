...
<body>
	...
	<script>
	 let totalData = [];
	 let url = `https://api.odcloud.kr/api/15077586/v1/centers?page=1&perPage=284&serviceKey=CrEGWCaqDe4kDzBd7t41msThdpVroNij6WZqujhAIm7AxqDJC7xbFT1U7dAnWxTdeSxJC%2BL7v9T8MJ1I1YlV8g%3D%3D`;
