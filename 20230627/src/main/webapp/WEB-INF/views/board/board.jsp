...
<hr>
<!-- 댓글부분. 시작 -->
<div calss="row" style="width: 85%; margin: 0 auto 0;">
	<div class="col-lg-12">
...
<div class="modal fade" id="myModal" style="top: 150px;">
			...
			<div class="modal_body">
				...
				<div class="form-group">
					<label for="">Replyer</label> <input class="form-control"
						name="replyer" value="user01">
				</div>
				<div class="form-group">
					<label for="">Reply Date</label> <input class="form-control"
						name="replyDate" value="2023-06-30 12:12:10">
				</div>
			</div>
			<!--footer-->
    ...
    document.querySelector('#addReplyBtn').addEventListener('click', function(e){
        ...
        //등록날짜 항목 숨김.
        document.querySelector('#myModal div.modal_body div.form-group:nth-child(3)').style.display = 'none';
    })

    // 조회버튼.
    function searchList(){
	    document.querySelectorAll('ul.chat li').forEach(function (tag) { //li에 이벤트 생성하지만 이때는 li가 없음.
	        tag.addEventListener('click', function (e){
	        	...
	        	.then(response => response.json()) //[{"name":"hong", "age":10}]
    ...
    .then(function(result){
        ...
        for(let reply of result){
            replyUL.innerHTML += makeList(reply); //li가 이때 만들어짐.
        }
        searchList();
    })
    .catch(function(err){
